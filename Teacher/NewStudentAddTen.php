...
<div class="container">
  ...
  <form action="" method="post">
    <div class="form-group">
      ...
      <input type="text" class="form-control"  placeholder="Enter paid Fess " name="pd" required="">

      <label for="">Remain</label>
      <input type="text" class="form-control"  placeholder="Enter Remain Fees " name="rm" required="">

      <label for="">Total</label>
      <input type="text" class="form-control"  placeholder="Enter Total Fees To Paid" name="Top" required="">
      ...
      <input type="number" class="form-control" id="email" placeholder="Enter Phone number" name="pn" required="">
   ...
   <a href="tendata.php" class="btn btn-warning">Back</a>
...
if (isset($_POST['dn']))
  ...
  $q=mysqli_query($con,"insert into studentendata (Rollno,Name,Email,Password,Standard,Sex,Phone,Address,Status)values('$rn','$nm','$em','$ps','$std','$se','$pn','$ad','$sta')");

  $q=mysqli_query($con,"insert into feesactivityten(Rollno,Name,Paid,Remain,Total)values('$rn','$name','$paid','$rem','$tot')");
