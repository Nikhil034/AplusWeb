...
<?php
  ...
  if(isset($_POST['rs']))
  {
     ...
     else
     {
      ...
      if($sb==9)
      {
       ...
       header("location:NineResult.php");
     }
     else
     {
      header("location:TenResult.php");
     }
 ...
 &nbsp &nbsp&nbsp &nbsp&nbsp &nbsp&nbsp &nbsp<input  type="submit" class="btn btn-success" value="Shows Table" name="tm">
  ...
  if(isset($_POST['tm']))
  {
     ...
     else
     {
      ...
      if($sb==9)
      {
       ...
       header("location:ShowTimeTableNine.php");
     }
     else
     {
      header("location:ShowTimeTableTen.php");
     }
