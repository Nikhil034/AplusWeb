...
<head>
   ...
   <title>Parent Data of 10th Class</title>
  <meta charset="utf-8">
...
<body>
 ...
 <nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">10th Data</li>
  </ol>
</nav>  
...
<div id="accordion2">
  ...
  <h4>Student 10th Parent Data</h4>
  ...
  <div class="card">
    ...
    <tr>
      ...
      <td>
        <a href="parentcontactupdateTen.php?i=<?php echo $row['User_id'];?>" class="btn btn-success text-white">
