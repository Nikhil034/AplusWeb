...
$rn=$_GET['i'];
$sq=mysqli_query($con,"select * from feesactivityten where Rollno='$rn'");
...
<div class="container">
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <input class="form-control" type="text" placeholder="Enter Remain Fees" name="rm" value="">
    </div> 
    </div> 
...
if(isset($_POST['fupdate']))
{
  ...
  $sq=mysqli_query($con,"update feesactivityten set Paid='$p',Remain='$rm' where Rollno='$rn'");
