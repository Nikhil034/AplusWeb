...
<div class="container">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">10th Howework</li>
  </ol>
</nav>
  ...
  <form action="" method="post">
   ...
   <input type="submit" class="btn btn-warning" value="View Work" name="view" formaction="HomeWorkViewTen.php">
...
if (isset($_POST['dn']))
  ...
  $q=mysqli_query($con,"insert into sethomeworkten(Subject,Std,Work,Details,Gdate,Cdate)values('$sub','$sd','$tit','$home','$give','$com')");
