...
$rn=$_GET['i'];
$sq=mysqli_query($con,"select * from studentninedata where RollNo='$rn'");
...
<div class="container">
  ...
  <form action="" method="post">
    <div class="form-group">
      ...
      <input type="number" class="form-control"  placeholder="Enter Standard" name="st" value="<?php echo $col[5];?>">

      <label for="sex">Sex</label>
      <input type="text" class="form-control"  placeholder="Enter Sex" name="se" value="<?php echo $col[6];?>">

      <label for="phoneno">Phoneno</label>
      <input type="text" class="form-control bg-danger" id="email" placeholder="Enter Phone number" name="pn" value="<?php echo $col[7];?>">
    ...
    <textarea class="form-control"  id="" rows="2" name="ad" ><?php echo $col[8 ];?></textarea>
      ...
      <input type="number" class="form-control" placeholder="Set Student Status" name="sta" min="0" max="1" value="<?php echo $col[10];?>">
   ...
   <input type="submit" class="btn btn-success" value="Done" name="dn">
     ...
     <input type="submit" class="btn btn-danger text white" value="Cancel"  formaction="ninedata1.php">
...
if (isset($_POST['dn']))
  ...
  $sta=$_POST['sta'];
   ...
   $up=mysqli_query($con,"UPDATE studentninedata SET Name='$nm', Email = '$em', Password = '$ps', Standard='$std',Phone = '$pn',Address='$ad',Status='$sta' WHERE RollNo = '$rn'");
