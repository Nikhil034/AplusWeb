...
<div class="container">
  ...
  <br>
  <a href="insertten.php" class="btn btn-primary"  style="float:right;">
  ...
  &nbsp<a href="DeleteAllRecordTen.php" class="btn btn-danger" style="float:center;">
  ...
  <path d="M2.5 1a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1H3v9a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V4h.5a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H10a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1H2.5zm3 4a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5zM8 5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7A.5.5 0 0 1 8 5zm3 .5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 1 0z"/>
    ...
    <a href="TenDataDownloadPdf.php" class="btn btn-success" style="float:left;">
    ...
    while($r=mysqli_fetch_array($s))
  {
   ...
   <td><?php echo $r['Rollno'];?></td> 
    ...
    <td><a href="StudentViewTen.php?i=<?php echo $r['Rollno'];?>" class="btn btn-primary">
     ...
     <!-- <td class="color">
         &nbsp  &nbsp &nbsp<a  href="updatest.php?i=<?php echo $r['RollNo'];?>">U
        &nbsp &nbsp<a href="delete.php?i=<?php echo $r['RollNo'];?>">D
 -->
    </tr>
    <?php
}
