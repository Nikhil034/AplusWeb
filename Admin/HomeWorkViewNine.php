...
$s=mysqli_query($con,"select * from sethomeworknine");
...
<body>
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="HomeWorkSet.php">9th HomeWork</a></li>
    ...
    if (isset($_POST['search']))
 {
   ...
   $sb=$_POST['sub'];
   $qu="SELECT * FROM sethomeworknine WHERE Subject='$sb' ";
