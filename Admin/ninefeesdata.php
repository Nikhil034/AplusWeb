...
<html lang="en">
<head>
  <title>Class 9th Fees Data</title>
  <meta charset="utf-8">
...
<div class="container">
  ...
  <div class="card">
    <div class="card-header">Student 9th Fees Details</div>
    <div class="card-body">
  ...
  <table class="table" id="tb" >
    ...
    <td><a href="FeesDataViewNine.php?i=<?php echo $row['Rollno'];?>" class="btn btn-primary">
