...
<html lang="en">
<head>
  <title>Student Attendance 10th Class view</title>
  <meta charset="utf-8">
    	...
    	<form method="post">       
  					<table class="table table-hover">
						...
						<?php
							...
							$q = mysqli_query($con,"select distinct Date from attendanceten");
							if($q->num_rows>0)
							{
								$i=0;
						...
						<tr>
							...
							<td><a href="TenAttendanceShow.php?Date=<?php echo $val['Date'] ?>" class="btn btn-primary">
