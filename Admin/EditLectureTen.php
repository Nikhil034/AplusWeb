...
$rn=$_GET['i'];
$sq=mysqli_query($con,"select * from lectureten where id='$rn'");
...
<div class="container">
  ...
  <ol class="breadcrumb">
   ...
   <a href="LectureScheduleTen.php" class="btn btn-warning"> Cancel</a>
...
if (isset($_POST['dn']))
  ...
  $Le=$_POST['Lec'];
   ...
   $up=mysqli_query($con,"UPDATE lectureten SET Time_Lec='$Le', Monday = '$Mo', Tuesday = '$Tu', Wednesday='$We',Thursday = '$Th',Friaday='$Fi',Saturday='$Sa' WHERE id = '$id'");
