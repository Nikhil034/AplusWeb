...
$s=mysqli_query($con,"select * from feesactivityten where Rollno='$id'");
...
<html>
<head>
  <title>Student Fees View 10th Class</title>
...
<div class="container">
  ...
  <table class="table table-hover">
    ...
    <div class="container">
    <a href="studentfeesupdateten.php?i=<?php echo $col['Rollno'];?>"><button type="button" class="btn btn-info btn-lg btn-block responsive-width">
        UPDATE
    </button>
