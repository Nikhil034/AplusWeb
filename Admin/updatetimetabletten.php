...
$no=$_GET['i'];
$sq=mysqli_query($con, "select * from timetableten where Sno='$no'");
   ...
   <form method="post">
    ...
    <div class="card-footer ">
      ...
      &nbsp    &nbsp   &nbsp   &nbsp  
         ...
         <input type="submit" class="btn btn-warning" value="Cancel" formaction="SetTimeTableTen.php"  >
    </div>
  </div>
</div>
</form>
...
if(isset($_POST['tbupdate']))
{
  ...
  $sq=mysqli_query($con,"update timetableten set Subject='$sb',Date='$dt',Marks='$ms' where Sno='$sn'");

   if($sq)
  {
   echo" <div class='alert alert-success'>
    <strong>Success!</strong> Table Update Succesfull
  </div>";
  }
  else
  {
